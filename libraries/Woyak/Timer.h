...
/// </summary>
/// <remarks>
/// See TimerBase for cadence behavior. Duration is specified in milliseconds.
/// </remarks>
///
...
/// </summary>
/// <remarks>
/// See TimerBase for cadence behavior. Duration is specified in microseconds.
/// </remarks>
///
...
/// </summary>
/// <remarks>
/// See TimerBase for cadence behavior. Duration is specified as a float in
/// seconds and converted internally to milliseconds for resolution.
/// </remarks>
///
...
///
/// <summary>
/// Timer specified by a rate (updates per second) - maintains cadence (does not drift)
/// </summary>
/// <remarks>
/// See TimerBase for cadence behavior. Duration is derived from a rate in updates
/// per second; a rate of 0 (or less) results in the timer always being ready.
/// </remarks>
///
class RateTimer : public TimerMillis
{
public:
   ///
   /// <summary>
   /// Constructs a RateTimer with the specified rate.
   /// </summary>
   /// <param name="ratePerSec">Rate in updates per second</param>
   ///
   explicit RateTimer(float ratePerSec)
      : TimerMillis(ratePerSec > 0.0f ? static_cast<unsigned long>(1000.0f / ratePerSec) : 0) {}
};
