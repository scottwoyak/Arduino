...
///
/// <summary>
/// A single named color entry: the display name paired with its Color value.
/// </summary>
///
struct ColorEntry
{
...
// Every named web/CSS color defined above (excludes the semantic aliases at the end of the
// enum, e.g. HEADING/VALUE/etc., which just duplicate one of these values).
inline const ColorEntry COLORS[] =
{
