...
//
class SW_ST7796S : public Adafruit_ST7796S
{
public:
...
public:
   ...
   Feather_ESP32_S3_ST7796S(uint8_t pinCS, uint8_t pinDC, uint8_t pinRST, uint8_t pinBACKLITE) : ArduinoWithDisplay(&display), display(pinCS, pinDC, pinRST), buttonA(0)
   {
