...
// Every named web/CSS color defined in Color.h (excludes the semantic aliases at the end
// of the enum, e.g. HEADING/VALUE/etc., which just duplicate one of these values).
