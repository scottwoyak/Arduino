...
public class VLWFont
{
   ...
   public void SaveAsSmoothFont(string folderPath, string name)
   {
      ...
      // TODO provide more details about this fond
      sb.Append("// VLW Font Generated by Smooth Fonts Generator\n");
      sb.Append("//   Source Font: \n");
      sb.Append("//   Glyph Height: " + this.Height + " px\n");
      sb.Append("//   Font Size: " + this.FontSizePx + " px\n");
      sb.Append("//\n");
      sb.Append('\n');
